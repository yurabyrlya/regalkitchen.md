    ...
    <div class="container-fluid py-6">
        <div class="container">
            ...
            <div class="owl-carousel owl-theme testimonial-carousel testimonial-carousel-1 mb-4 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="testimonial-item rounded bg-light">
                    <div class="d-flex mb-3">
                        <img src="public/img/testimonial-2.jpg" class="img-fluid rounded-circle flex-shrink-0" alt="">
                        <div class="position-absolute" style="top: 15px; right: 20px;">
                            <i class="fa fa-quote-right fa-2x"></i>
                        </div>
                        <div class="ps-3 my-auto">
                ...
                <div class="testimonial-item rounded bg-light">
                    <div class="d-flex mb-3">
                        <img src="public/img/testimonial-3.jpg" class="img-fluid rounded-circle flex-shrink-0" alt="">
                        <div class="position-absolute" style="top: 15px; right: 20px;">
                            <i class="fa fa-quote-right fa-2x"></i>
                        </div>
                        <div class="ps-3 my-auto">
                ...
                <div class="testimonial-item rounded bg-light">
                    <div class="d-flex mb-3">
                        <img src="public/img/testimonial-4.jpg" class="img-fluid rounded-circle flex-shrink-0" alt="">
                        <div class="position-absolute" style="top: 15px; right: 20px;">
                            <i class="fa fa-quote-right fa-2x"></i>
                        </div>
                        <div class="ps-3 my-auto">
